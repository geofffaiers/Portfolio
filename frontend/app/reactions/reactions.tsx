        ...
        <div className='relative w-full h-full overflow-hidden' ref={componentRef}>
            ...
            {displayGame && (
                <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center'>
                    <div className={`duration-200 ${animateScore ? 'transform scale-150' : ''} text-6xl font-bold text-white select-none text-center`}>
            ...
            {playing && (
                <>
                    <div className='absolute bottom-0 left-1/2 transform -translate-x-1/2 mb-4 text-white text-xl'>
