...
import { CircularProgress, DialogContent, DialogTitle, FormControl, FormHelperText, FormLabel, Input, Modal, ModalClose, ModalDialog, Stack } from '@mui/joy'
  ...
  return (
    <>
      ...
      >
        ...
        <Button type='submit' variant='default' disabled={!userChanged}>
          Save Changes
        </Button>
        <Button type='button' variant='secondary' onClick={() => setShowChangePassword(true)}>
          Change Password
        </Button>
        <Button type='button' variant='destructive' onClick={() => setShowDeleteAccount(true)}>
          Delete My Account
        </Button>
      </form>
